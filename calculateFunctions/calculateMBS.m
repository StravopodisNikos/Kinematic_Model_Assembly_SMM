function [MBS] = calculateMBS(structure,assembly_parameters,xi_ai_ref,xi_pj_ref,qp,point2figure)
...
[~,xi_ai_anat,M_s_com_k_i_anat,g_s_com_k_i_anat] = calculateCoM_ki_s_structure_anatomy(structure,assembly_parameters,qp,xi_pj_ref,point2figure);
