function MB_star = obj_fn_mass_balancing_structure_optimization_maxMBS(x)
...
[max_MBS_anat] = calculateExhaustiveAnatomies_for_MBS(structure,assembly_parameters,'max',xi_ai_ref,xi_pj_ref);
