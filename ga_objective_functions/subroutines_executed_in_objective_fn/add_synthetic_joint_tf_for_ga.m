function [synthetic_tform,g_s_m_i1,error_msg] = add_synthetic_joint_tf_for_ga(nDoF_string,synthetic_name,g_s_m_i,assembly_parameters,assembly_index)
...
switch synthetic_name
    ...
    case 'active_assembly'
        switch nDoF_string
            ...
            case '6dof'                
                if assembly_index <= 3
                    active2pseudo_origin_p = assembly_parameters(10,assembly_index);
                else
                    active2pseudo_origin_p = assembly_parameters(11,assembly_index-3);
                end
            otherwise
              warning('[add_synthetic_joint_tf_for_ga]: nDoF string NOT valid! ')      
        end
    otherwise
