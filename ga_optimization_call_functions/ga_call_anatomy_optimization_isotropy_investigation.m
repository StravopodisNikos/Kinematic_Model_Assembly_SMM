...
LB1 = [1    1    1   1 ];
<<<<<<< HEAD
UB1 = [13   13   13  13];  % for step_angle = deg2rad(15); 
Bound = [LB1; UB1];
% Option settings
generations = 300;
population = 250;
...
toc;
save('s1_4_11_anatomy_optimization_dyn_isotropy_25_11_20.mat','generations','population','tolerance','stall_limit','X_mult1','Fval_mult1','exitflag_mult1','output_mult1','ga_structure_name');
=======
...
toc;
save('s2_4_11_anatomy_optimization_dyn_isotropy_25_11_20.mat','generations','population','tolerance','stall_limit','X_mult2','Fval_mult2','exitflag_mult2','output_mult2','ga_structure_name');
=======
UB1 = [13.9999999   13.9999999   13.9999999  13.9999999];  % for step_angle = deg2rad(15); 
Bound = [LB1; UB1];
% Option settings
...
toc;
save('s3_4_11_anatomy_optimization_dyn_isotropy_25_11_20.mat','generations','population','tolerance','stall_limit','X_mult3','Fval_mult3','exitflag_mult3','output_mult3','ga_structure_name');
=======
