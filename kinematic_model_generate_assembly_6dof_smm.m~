...
structure(9,:) = passive_under_string_notation;
...
assembly_parameters(10,3) = 1.5708;                   % 2nd dxl assembly pitch parameter
...
qa = [0 0 0 0 0 0]';
%      s2       s3    s5     s6  s8   s9  s11  s12 s14  s15
qp = [1.5708 0.5 0 0.7854 -0.7854 0 0 1.5708 0 -1.5708]';
