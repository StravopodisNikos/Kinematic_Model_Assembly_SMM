...
% 1.b the manipulator has three parallel revolute axes
% 2.  the manipulator has three intersecting perpendicular pairs

% Here condition 1 is investigated for a 6 DoF SMM structure
...
switch criterion
    ...
    otherwise
        warning('[find_special_anatomies_degree4_conditions]: Condition specified NOT valid')
end
