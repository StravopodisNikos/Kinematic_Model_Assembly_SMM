...
synthetic4_origin_z = 0;        %added as var, default 0
synthetic4_origin_p = -1.5708;   %var \in [-1.5708 ~ 1.5708]

synthetic5_origin_x = 0.01;   %added as var, default 0
synthetic5_origin_z = -0.015;   %var \in [-0.015~0.025]
synthetic5_origin_p = 0;        %var \in [-1.5708 ~ 1.5708]

active2pseudo_origin_p = 0; % can take 2 values \in [0,1.5708]
% ==================================================
...
switch synthetic_name
    ...
    case 'synthetic2'   % pseudo_moving->pseudo_static_under
        ...
        syn2_xyz = [synthetic2_origin_x 0.1444 synthetic2_origin_z]';
    ...
    case 'synthetic3'   % pseudo_moving->pseudo_static_under
        syn3_rpy = [0 synthetic3_origin_p 0];
        syn3_xyz = [synthetic3_origin_x 0.0955 synthetic3_origin_z]';
    ...
    case 'synthetic4'   % pseudo_moving->pseudo_static_under
        ...
        syn4_xyz = [synthetic4_origin_x 0.101 synthetic4_origin_z]';
...
%         synthetic_tform(1:3,4) = syn4_xyz;
    ...
    case 'synthetic5'   % pseudo_moving->pseudo_static_under
        syn5_rpy = [-1.5708 synthetic5_origin_p 0];
        syn5_xyz = [ synthetic5_origin_x 0.0525 synthetic5_origin_z]';
