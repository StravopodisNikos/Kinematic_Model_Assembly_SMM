function [torque,V,pos_error] = postODEoutput_PID_computed_torque_control_3DoF_MMD(x,x_d,ddq_d,dt,meta_params_struct,s_pid,Vold)
...
torque = torque';
pos_error = e(4:6,1)';            % pos error = q_d -q
end